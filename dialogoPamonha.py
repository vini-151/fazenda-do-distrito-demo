...
class GameView(arcade.View):
    def __init__(self):
        ...
        self.dialog_page = 0
        self.dialog_texts = [
            "Aqui é o onde fazemos nossas deliciosas pamonhas.",
            "É quase um evento para nossa fazenda! ",
            "Nos reunimos aqui para conversar", ""
            "e prestigiar o nosso delicioso tesouro de milho."
        ]

        self.background_sprite = arcade.Sprite("pamonha.png", scale=0.5)
