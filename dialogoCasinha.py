...
class GameView(arcade.View):
    def __init__(self):
        ...
        self.dialog_page = 0
        self.dialog_texts = [
            "Aqui é o onde o nosso descanso é feito.",
            "Ninguém é de ferro, não é mesmo?."
        ]

        self.background_sprite = arcade.Sprite("casinha.png", scale=0.5)
    ...
    def setup(self):
        ...
        self.player_sprite.center_x = SCREEN_WIDTH - 600
